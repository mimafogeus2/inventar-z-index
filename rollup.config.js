...
export default () => [
	{
		...
		output: [
			{
				file: `${OUTPUT_DIR}/main/inventarZIndex.js`,
				format: 'cjs',
				exports: 'named',
				sourcemap: true,
			...
			{
				file: `${OUTPUT_DIR}/main/inventarZIndex.min.js`,
				format: 'cjs',
				exports: 'named',
				sourcemap: true,
			...
			{
				file: `${OUTPUT_DIR}/module/inventarZIndex.esm.js`,
				format: 'esm',
				sourcemap: true,
				plugins: [TERSER_READABLE],
			},
			{
				file: `${OUTPUT_DIR}/external/inventarZIndex.min.js`,
				format: 'iife',
				exports: 'named',
				name: 'inventarZIndex',
				sourcemap: true,
	...
	{
		input: ['./src/index.ts'],
		output: [{ file: `${OUTPUT_DIR}/main/inventarZIndex.d.ts` }, { file: `${OUTPUT_DIR}/module/inventarZIndex.d.ts` }],
		plugins: [dts()],
	},
]
